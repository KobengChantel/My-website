...
function replaceIt() {
    ...
    theStory += "Second " + adj1 + " day, David was " + verbIng + " in his " + roomInHouse + ", reading a book about " + color + " " + nounPlural + ".<br><br>";
    ...
    theStory += "David danced the " + animal + " Dance, the " + city + " Shake, and took the prize for dancing the best Electric " + verb + ".<br><br>";
